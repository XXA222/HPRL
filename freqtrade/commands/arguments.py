...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        # Optional Hedge commands use one stable registration hook for upstream rebases.
        from freqtrade.commands.hedge_cli import register_hedge_subcommands
        ...
        register_hedge_subcommands(
            ...
            _common_parser,
            _strategy_parser,
            trade_options=ARGS_TRADE,
            backtest_options=ARGS_BACKTEST,
        )
