...
class LocalTrade:
    ...
    bt_trades_open_pps: dict[tuple[str, str], list["LocalTrade"]] = defaultdict(list)
    ...
    def get_trades_proxy_by_position(
        ...
        *,
        ...
        return [
            trade
            for trade in trades
            if getattr(trade, "position_side", PositionSide.BOTH.value)
            == normalized_side
        ]
    ...
    def get_open_trades_for_pair_side(
        ...
        if not cls.use_db:
            return list(
                LocalTrade.bt_trades_open_pps.get((pair, normalized_side), [])
            )
...
class Trade(ModelBase, LocalTrade):
    ...
    bt_trades_open_pps: ClassVar[
        dict[tuple[str, str], list["LocalTrade"]]
